...
assert.match(analytics,/defenseTrainingStats/);assert.match(sw,/baseball-diary-v7\.7\.0/);assert.match(sw,/\.\/js\/defense-training\.js\?v=7\.7\.0/);assert.match(html,/js\/app\.js\?v=7\.7\.0/);assert.equal(read('VERSION').trim(),'7.7.0');
