...
assert.equal(read('VERSION').trim(),'7.10.0');assert.match(html,/야구일기 V7\.10\.0/);assert.match(sw,/baseball-diary-v7\.10\.0/);

console.log('V7.6 direct-out defense regression tests on V7.10.0: PASS');
