...
assert.equal(read('VERSION').trim(),'7.9.1');assert.match(html,/야구일기 V7\.9\.1/);assert.match(sw,/baseball-diary-v7\.9\.1/);

console.log('V7.6 direct-out defense regression tests on V7.9.1: PASS');
