...
assert.equal(read('VERSION').trim(),'7.9.1');assert.match(app,/appVersion:'7\.9\.1'/);assert.match(sw,/baseball-diary-v7\.9\.1/);assert.match(sw,/\.\/js\/defense\.js\?v=7\.9\.1/);assert.match(html,/js\/app\.js\?v=7\.9\.1/);
