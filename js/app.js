...
async function buildBackupPayload(){
  ...
  return {version:7,schemaVersion:7,appVersion:'7.9.1',exportOwnerId:uid,exportEmailHint:maskEmail(cloud.session?.user?.email||''),exportedAt:iso(),data:accountData};
}
