const CACHE='baseball-tracker-pro-v6.4.0';
const CORE=['./','./index.html','./styles.css?v=6.4.0','./js/storage.js?v=6.4.0','./js/analytics.js?v=6.4.0','./js/app.js?v=6.4.0','./manifest.webmanifest?v=6.4.0','./icon-192.png','./icon-512.png','./supabase-config.js?v=6.4.0'];
