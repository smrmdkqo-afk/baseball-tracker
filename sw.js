const CACHE='baseball-diary-v7.9.0';
const CORE=['./','./index.html','./styles.css?v=7.9.0','./js/storage.js?v=7.9.0','./js/analytics.js?v=7.9.0','./js/analysis-scope.js?v=7.9.0','./js/defense.js?v=7.9.0','./js/defense-training.js?v=7.9.0','./js/app.js?v=7.9.0','./manifest.webmanifest?v=7.9.0','./icon-192-v7.1.0.png','./icon-512-v7.1.0.png','./icon-512-maskable-v7.1.0.png','./vendor/supabase-2.112.3.min.js?v=7.9.0','./supabase-config.js?v=7.9.0'];
